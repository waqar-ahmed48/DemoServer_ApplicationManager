...
func main() {
	...
	patchVersionRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}", ah.UpdateVersion)
	...
	uploadPackageRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/package", ah.UploadPackage)
	...
	downloadPackageRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/package", ah.GetPackageLink)
	...
	listStateRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/state/resource", ah.ListState)
	...
	moveStateResourceRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/state/move", ah.MoveStateResource)
	...
	removeStateResourceRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/state/remove", ah.RemoveStateResource)
	...
	importStateResourceRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/state/import", ah.ImportStateResource)
	...
	listWorkspaceRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/workspaces", ah.GetWorkspaces)
	...
	selectWorkspaceRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/workspace/select/{workspacename:[a-fA-F0-9]{20}}", ah.SelectWorkspace)
	selectWorkspaceRouter.Use(otelhttp.NewMiddleware("POST /application/version/workspace/select/{workspacename}"))
	selectWorkspaceRouter.Use(ah.MVSelectWorkspace)

	showWorkspaceRouter := r.Methods(http.MethodGet).Subrouter()
	showWorkspaceRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/workspace/{workspacename:[a-fA-F0-9]{20}}", ah.ShowWorkspace)
	showWorkspaceRouter.Use(otelhttp.NewMiddleware("GET /application/version/workspace/{workspacename}"))
	showWorkspaceRouter.Use(ah.MVShowWorkspace)

	deleteWorkspaceRouter := r.Methods(http.MethodDelete).Subrouter()
	deleteWorkspaceRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/workspace/{workspacename:[a-fA-F0-9]{20}}", ah.DeleteWorkspace)
	deleteWorkspaceRouter.Use(otelhttp.NewMiddleware("DELETE /application/version/workspace/{workspacename}"))
	deleteWorkspaceRouter.Use(ah.MVDeleteWorkspace)

	createWorkspaceRouter := r.Methods(http.MethodPost).Subrouter()
	createWorkspaceRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/workspace", ah.CreateWorkspace)
	...
	graphTofuRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/tofu/graph", ah.GraphTofu)
	graphTofuRouter.Use(otelhttp.NewMiddleware("GET /application/version/{version}/tofu/graph"))
	graphTofuRouter.Use(ah.MVGraphTofu)

	outputRouter := r.Methods(http.MethodGet).Subrouter()
	outputRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/output", ah.Output)
	...
	refreshRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/refresh", ah.Refresh)
	...
	destroyRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/destroy", ah.Destroy)
	...
	applyRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/apply", ah.Apply)
	...
	planRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/plan", ah.Plan)
	...
	validateRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/validate", ah.Validate)
	...
	hclvalidateRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/hclvalidate", ah.HclValidate)
	...
	initRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/init", ah.Init)
	...
	fmtRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/fmt", ah.Fmt)
	...
	hclfmtRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/hclfmt", ah.HclFmt)
	...
	forceUnlockRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/force-unlock", ah.ForceUnlock)
	...
	providersRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/providers", ah.Providers)
	...
	validateInputsRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/validate-inputs", ah.ValidateInputs)
	...
	taintRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/taint", ah.Taint)
	...
	untaintRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/untaint", ah.Untaint)
	...
	testRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/test", ah.Test)
	...
	renderJsonRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/render-json", ah.RenderJson)
	...
	runAllRouter.HandleFunc("/v1/applicationmgmt/application/{applicationid:[a-fA-F0-9]{8}-[a-fA-F0-9]{4}-4[a-fA-F0-9]{3}-[8|9|aA|bB][a-fA-F0-9]{3}-[a-fA-F0-9]{12}$}/version/{versionid:[0-9]{4}}/run-all", ah.RunAll)
